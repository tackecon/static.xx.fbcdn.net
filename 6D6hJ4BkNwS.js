...
(function(a){if(a.require!=null)return;var b=null,c=null,d=[],e={},f={},g=0,h=0,i=0,j=0,k=0,l=1,m=2,n=4,o=8,p=16,aa=32,ba=64,ca={},q={},r=Object.prototype.hasOwnProperty,s=Object.prototype.toString;function t(a){a=Array.prototype.slice.call(a);var b={},c,d,f,g;while(a.length){d=a.shift();if(b[d])continue;b[d]=!0;f=e[d];if(!f||U(f))continue;if(f.dependencies)for(c=0;c<f.dependencies.length;c++)g=f.dependencies[c],U(g)||a.push(g.id)}for(d in b)r.call(b,d)&&a.push(d);b=[];for(c=0;c<a.length;c++){d=a[c];var h=d;f=e[d];d=f?f.dependencies:null;if(!f||!d)h+=" is not defined";else if(U(f))h+=" is ready";else{f=[];for(var i=0;i<d.length;i++)g=d[i],U(g)||f.push(g.id);h+=" is waiting for "+f.join(", ")}b.push(h)}return b.join("\n")}function u(b){var a=new Error(b);a.name="ModuleError";a.messageFormat=b;for(var c=arguments.length,d=new Array(c>1?c-1:0),e=1;e<c;e++)d[e-1]=arguments[e];a.messageParams=d.map(function(a){return String(a)});a.taalOpcodes=[2,2];return a}$=a.Env||{};var v=!!$.gk_require_when_ready_in_order,da=!!$.gk_clear_js_factory_after_used,w=!!$.profile_require_factories,x=a.performance||{},y;if(x.now&&x.timing&&x.timing.navigationStart){var z=x.timing.navigationStart;y=function(){return x.now()+z}}else y=function(){return Date.now()};var A=0;function B(a){A++;var b=e[a];(!b||b.exports==null&&!b.factoryFinished)&&(G(a),b=e[a]);b&&b.refcount--===1&&(e[a]=null);return b}function C(a){return a.defaultExport!==q?a.defaultExport:a.exports}function D(a){a=B(a);if(a)return C(a)}function E(a){a=B(a);if(a)return a.defaultExport!==q?a.defaultExport:null}function F(a){a=B(a);if(a)return a.exports}function ea(a){a.factoryLength===-1&&(a.factoryLength=a.factory.length);return a.factoryLength}function G(d){var g=a.ErrorGuard;if(g&&!g.inGuard())return g.applyWithGuard(G,null,[d]);g=e[d];if(!g){var h='Requiring unknown module "%s"';throw u(h,d)}a.__onBeforeModuleFactory==null?void 0:a.__onBeforeModuleFactory(g);var i,j;if(g.hasError)if(g.error==null)throw u('Requiring module "%s" which threw an exception',d);else{h=H(g.error);I(h,{messageFormat:'Requiring module "%s" which threw an exception',messageParams:[d]});throw h}if(!U(g))throw u('Requiring module "%s" with unresolved dependencies: %s',d,t([d]));K(g);h=g.exports={};var k=g.factory,l=g.dependencies;if(s.call(k)==="[object Function]"&&l!=null){var n=l.length,p,q;try{try{wa(g)}catch(a){J(a,d)}var v=[],x=n;if(g.special&o){var z=g.special&aa?c:b;v=z.slice(0);v[z.length-2]=g;v[z.length-1]=h;x+=v.length}if(g.special&m){z=ea(g);x=Math.min(n+v.length,z)}for(h=0;h<n;h++){z=l[h];v.length<x&&v.push(D.call(null,z.id))}var A;w&&(A=y());f[g.id].factoryRun=!0;try{z=g.context!=null?g.context:a;p=k.apply(z,v)}catch(a){J(a,d)}finally{if(w){x=y();l=f[g.id];l.factoryTime=x-(A||0);l.factoryEnd=x;l.factoryStart=A;if(k.__SMmeta)for(n in k.__SMmeta)Object.prototype.hasOwnProperty.call(k.__SMmeta,n)&&(l[n]=k.__SMmeta[n])}}}catch(a){g.hasError=!0;g.error=a;g.exports=null;throw a}finally{}p&&(g.exports=p);var B;g.special&ba?g.exports!=null&&r.call(g.exports,"default")&&(g.defaultExport=B=g.exports["default"]):g.defaultExport=B=g.exports;if(typeof B==="function"){h=B.__superConstructor__;if(!B.displayName||h&&h.displayName===B.displayName)try{B.displayName=(B.name||"(anonymous)")+" [from "+d+"]"}catch(a){}}g.factoryFinished=!0;da&&(g.factory=null,k=void 0)}else g.exports=k;z="__isRequired__"+d;v=e[z];v&&!U(v)&&S(z,ca);a.__onAfterModuleFactory==null?void 0:a.__onAfterModuleFactory(g)}function H(b){if(a.getErrorSafe!=null)return a.getErrorSafe(b);return b!=null&&typeof b==="object"&&typeof b.message==="string"?b:u("Non-error thrown: %s",String(b))}function I(b,c){var d=a.ErrorSerializer;d&&d.aggregateError(b,c)}function J(a,b){a=H(a);I(a,{messageFormat:'Module "%s"',messageParams:[b],forcedKey:b.startsWith("__")?null:b});throw a}function fa(){return A}function ga(){var a={};for(var b in f)Object.prototype.hasOwnProperty.call(f,b)&&(a[b]=f[b]);return a}function K(a){if(a.nonJSDeps)return;a.nonJSDeps=!0;a.dependencies&&a.dependencies.forEach(K)}var L=!!(a!=null&&a.document!=null&&"createElement"in a.document),M=$.use_fbt_virtual_modules===!0&&L,ha="$fbt_virtual",N={},O=null,P=6e4;function ia(a,b){!(a in e)&&!(a in N)&&(N[a]={injectTime:y(),hash:b?b.dataset.bootloaderHash||b.dataset.bootloaderHashClient:null}),O||(O=setTimeout(Z()(Q,"_checkFbtVirtualModuleTimeout"),P))}function Q(){O=null;M||T.apply(null,[["FBLogger"],function(a){a("binary_transparency","invalid_vmod_use").mustfix("_checkFbtVirtualModuleTimeout timeout queued when USE_FBT_VIRTUAL_MODULES is false!")}]);a.__translationFetchTracker==null&&(a.__translationFetchTracker={});var b=a.__translationFetchTracker,c=y(),d={};for(var e in N){var f=N[e],g=f.hash;f=f.injectTime;if(c-f<=P)continue;f=g==null||!(g in b)||b[g]==="fetched";if(f){f=g!=null?g:"unknown";d[f]=d[f]||[];d[f].push(e);delete N[e]}else g!=null&&b[g]==="failed"&&delete N[e]}Object.keys(N).length>0&&(O=setTimeout(Z()(Q,"_checkFbtVirtualModuleTimeout"),P));Object.keys(d).length>0&&T.apply(null,[["FBLogger"],function(a){for(var b in d)a("binary_transparency","vmod_timeout").warn("The following virtual modules in resource %s are taking over %sms to be defined: %s...",b,P,d[b].join(",").slice(0,300))}])}var R=["fbt","fbs","errorDesc","adsErrorDesc","codedError","errorSummary"],ja=["IFBT","isFbtTranslated"];function ka(a,b,c){if(!M)return;if(R.indexOf(a)!==-1||ja.indexOf(a)!==-1)return;for(var d=0;d<b.length;d++)if(R.indexOf(b[d])!==-1){var e=a+ha;b.push(e);ia(e,c);break}}function S(b,c,e,g,h,i,l,m){c===void 0?(c=[],e=b,b=oa()):e===void 0&&(e=c,s.call(b)==="[object Array]"?(c=b,b=oa(c.join(","))):c=[]);var n={cancel:na.bind(this,b)},o=la(b);if(!c&&!e&&i){o.refcount+=i;return n}M&&(b in N&&delete N[b],Array.isArray(c)&&ka(b,c,m));f[b]={id:b,dependencies:c,meta:l,category:g,defined:w?y():null,factoryTime:null,factoryStart:null,factoryEnd:null,factoryRun:!1};if(o.dependencies&&o.reload!==!0){b.indexOf(":")!=-1?k++:j++;return n}i&&(o.refcount+=i);m=c.map(la);o.factory=e;o.dependencies=m;o.context=h;o.special=g;(o.nonJSDeps||va(o))&&(o.nonJSDeps=!1,K(o));V(o);if(d.length>0){var p=d;d=[];l=a.ScheduleJSWork?a.ScheduleJSWork:za;l(function(){if(v){for(var a=0;a<p.length;a++)D.call(null,p[a].id);p.length=0}else while(p.length>0)D.call(null,p.pop().id)})()}return n}function la(a){var b=e[a];if(b)return b;b=new ma(a,0);e[a]=b;return b}function ma(a,b,c){this.id=a,this.refcount=b,this.exports=c||null,this.defaultExport=c||q,this.factory=void 0,this.factoryLength=-1,this.factoryFinished=!1,this.dependencies=void 0,this.depPosition=0,this.context=void 0,this.special=0,this.hasError=!1,this.error=null,this.ranRecursiveSideEffects=!1,this.sideEffectDependencyException=null,this.nextDepWaitingHead=null,this.nextDepWaitingNext=null,this.tarjanGeneration=-1,this.tarjanLow=0,this.tarjanIndex=0,this.tarjanOnStack=!1,this.nonJSDeps=!1}function na(a){if(!e[a])return;var b=e[a];e[a]=null;if(b.dependencies)for(a=0;a<b.dependencies.length;a++){var c=b.dependencies[a];c.refcount--===1&&na(c.id)}}function T(a,b,c){var d="__requireLazy__x__"+g++;return S("__requireLazy__"+d,a,Z()(b,"requireLazy",{propagationType:0}),l|p,c,1)}function oa(a){return"__mod__"+(a!=null?a+"__":"")+g++}function pa(a,b,c){c.tarjanGeneration!=h&&(c.tarjanGeneration=h,c.tarjanLow=c.tarjanIndex=i++,c.tarjanOnStack=!0,b.push(c));if(c.dependencies!=null)for(var d=c.depPosition;d<c.dependencies.length;d++){var e=c.dependencies[d];e.tarjanGeneration!=h?(pa(a,b,e),c.tarjanLow=Math.min(c.tarjanLow,e.tarjanLow)):e.tarjanOnStack&&(c.tarjanLow=Math.min(c.tarjanLow,e.tarjanIndex))}if(c.tarjanLow==c.tarjanIndex){e=[];do{d=b.pop();d.tarjanOnStack=!1;e.push(d);if(c==b[0]&&d!=c&&d.dependencies!=null)for(var f=d.depPosition;f<d.dependencies.length;f++){var g=d.dependencies[f];!U(g)&&a.indexOf(g)==-1&&b.indexOf(g)==-1&&e.indexOf(g)==-1&&a.push(g)}}while(d!=c)}}function qa(a){var b=a.dependencies;if(!b)throw u("Called _replaceCycleLinkWithSCCDeps on an undefined module");h++;pa(b,[],a);a.depPosition++;V(a)}function ra(a,b){var c=b;while(!0){if(c.dependencies&&c.depPosition!=c.dependencies.length)c=c.dependencies[c.depPosition];else break;if(c==a){qa(a);return}}a.nextDepWaitingNext=b.nextDepWaitingHead;b.nextDepWaitingHead=a}function U(a){return a.dependencies!=null&&a.depPosition>=a.dependencies.length}function sa(a){a.depPosition++,V(a)}function ta(a){var b=a.nextDepWaitingHead;a.nextDepWaitingHead=null;while(b!=null){var c=b;c.nonJSDeps&&K(a);b=c.nextDepWaitingNext;c.nextDepWaitingNext=null;var d=!e[c.id];d||sa(c)}}function ua(a){return a.special&l}function va(a){return a.special&p}function V(a){while(a.dependencies!=null&&a.depPosition<a.dependencies.length){var b=a.dependencies[a.depPosition],c=U(b);if(!c&&a!=b){ra(a,b);return}a.depPosition++}ua(a)&&d.push(a);a.nextDepWaitingHead!==null&&ta(a)}function wa(a){if(a.sideEffectDependencyException!=null)throw a.sideEffectDependencyException;if(a.ranRecursiveSideEffects)return;a.ranRecursiveSideEffects=!0;var b=a.dependencies;if(b)for(var c=0;c<b.length;c++){var d=b[c];try{wa(d)}catch(b){a.sideEffectDependencyException=b;throw b}if(d.special&n)try{D.call(null,d.id)}catch(b){a.sideEffectDependencyException=b;throw b}}}function W(a,b){e[a]=new ma(a,0,b),f[a]={id:a,dependencies:[],category:0,factoryLengthAccessTime:null,factoryTime:null,factoryStart:null,factoryEnd:null,factoryRun:!1}}W("module",0);W("exports",0);W("define",S);W("global",a);W("require",D);W("requireInterop",D);W("importDefault",E);W("importNamespace",F);W("requireDynamic",xa);W("requireLazy",T);W("requireWeak",X);W("ifRequired",ya);W("ifRequireable",Y);b=[D.call(null,"global"),D.call(null,"require"),D.call(null,"requireDynamic"),D.call(null,"requireLazy"),D.call(null,"requireInterop"),null];c=[D.call(null,"global"),D.call(null,"require"),D.call(null,"importDefault"),D.call(null,"importNamespace"),D.call(null,"requireLazy"),D.call(null,"requireInterop"),null];S.amd={};a.define=S;a.require=D;a.requireInterop=D;a.importDefault=E;a.importNamespace=F;a.requireDynamic=xa;a.requireLazy=T;a.__onBeforeModuleFactory=null;a.__onAfterModuleFactory=null;function xa(a,b){throw new ReferenceError("requireDynamic is not defined")}function X(a,b){ya.call(null,a,function(a){b(a)},function(){S("__requireWeak__"+a+"__"+g++,["__isRequired__"+a],Z()(function(){return b(C(e[a]))},"requireWeak"),l,null,1)})}function ya(a,b,c){a=e[a];if(a&&a.factoryFinished){if(typeof b==="function")return b(C(a))}else if(typeof c==="function")return c()}function Y(a,b,c){var d=e[a];if(d&&d.nonJSDeps&&U(d)){if(typeof b==="function")return b(D.call(null,a))}else if(typeof c==="function")return c()}$={getDupCount:function(){return[j,k]},getModules:function(){var a={};for(var b in e)e[b]&&Object.prototype.hasOwnProperty.call(e,b)&&(a[b]=e[b]);return a},modulesMap:e,debugUnresolvedDependencies:t};function za(a){return a}function Z(){var b=a.TimeSlice&&a.TimeSlice.guard?a.TimeSlice.guard:za;return function(){return b.apply(void 0,arguments)}}W("__getTotalRequireCalls",fa);W("__getModuleTimeDetails",ga);W("__debug",$);a.__d=function(a,b,c,d,e){Z()(function(){S(a,b,c,(d||m)|o,null,null,null,e)},"define "+a,{root:!0})()};function $(a,b){return!0}if(a.__d_stub){for(L=0;L<a.__d_stub.length;L++)a.__d.apply(null,a.__d_stub[L]);delete a.__d_stub}if(a.__rl_stub){for(X=0;X<a.__rl_stub.length;X++)T.apply(null,a.__rl_stub[X]);delete a.__rl_stub}Y=function(){};a.$RefreshReg$=Y;a.$RefreshSig$=function(){return function(a){return a}}})(typeof this!=="undefined"?this:typeof global!=="undefined"?global:typeof window!=="undefined"?window:typeof self!=="undefined"?self:{});
...
__d("BootloaderPreloader",["invariant","BootloaderDocumentInserter","ExecutionEnvironment","FBLogger","nullthrows"],(function(a,b,c,d,e,f,g,h){"use strict";var i,j=new Set(),k=new Set();function a(a){var b=a.allResources,e=a==null?void 0:(a=a.hsrp)==null?void 0:(a=a.hblp)==null?void 0:a.rsrcMap;if(e==null){c("FBLogger")("BootloaderPreloader").warn("Missing resource map in worker hrp");return}if(b==null){c("FBLogger")("BootloaderPreloader").warn("Missing allResources list in worker hrp");return}d("BootloaderDocumentInserter").batchDOMInsert(function(a){b.forEach(function(b){b=e[b];if(!b||b.type!=="js")return;l(b,a,"prefetch")})})}function l(a,b,d){d===void 0&&(d="preload");if((i||(i=c("ExecutionEnvironment"))).isInWorker)return;b=c("nullthrows")(b);var e=void 0;switch(a.type){case"async":return;case"css":e="style";break;case"js":e="script";break;default:e=a.type,h(0,3721)}if(j.has(a.src)||d==="prefetch"&&k.has(a.src))return;d==="preload"?j.add(a.src):d==="prefetch"?k.add(a.src):h(0,77517);if(a.d===1)return;var f=document.createElement("link");f.href=a.src;f.rel=d;d==="preload"&&(f.as=e);a.nc||(f.crossOrigin="anonymous");b.appendChild(f)}g.preloadWorkerJSFromHRP=a;g.preloadResource=l}),98);
...
__d("NetworkStatus",["NetworkStatusImpl","NetworkStatusSham","gkx"],(function(a,b,c,d,e,f,g){"use strict";a=c("gkx")("20935")&&c("gkx")("20936")?d("NetworkStatusImpl"):d("NetworkStatusSham");b=a;g["default"]=b}),98);
...
__d("SchedulerFeatureFlags",["gkx","qex"],(function(a,b,c,d,e,f,g){var h,i;a=!0;b=c("gkx")("21074");e=(d=c("qex")._("39"))!=null?d:!0;f=e;d=(d=c("qex")._("44"))!=null?d:5;var j=10,k=10;h=(h=c("qex")._("526"))!=null?h:250;i=(i=c("qex")._("538"))!=null?i:5e3;c=(c=c("qex")._("543"))!=null?c:1e4;g.enableSchedulerDebugging=a;g.enableProfiling=b;g.enableIsInputPending=e;g.enableIsInputPendingContinuous=f;g.frameYieldMs=d;g.continuousYieldMs=j;g.maxYieldMs=k;g.userBlockingPriorityTimeout=h;g.normalPriorityTimeout=i;g.lowPriorityTimeout=c}),98);
